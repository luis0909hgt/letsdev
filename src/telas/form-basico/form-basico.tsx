...
function tagPorNome(nomeTag: string, isRadioButton: boolean) {
  ...
  function enviarFormulario(event: FormEvent) {
    ...
    const nome = tagPorNome("nome", false)?.value;
    const idade = tagPorNome("idade", false)?.value;
    const ocupacao = tagPorNome("ocupacao", false)?.value;
    const areaPreferencia = tagPorNome("area-preferencia", true)?.value;
    const curriculo = tagPorNome("curriculo", false);
    const descricaoPerfil = tagPorNome("descricao-perfil", false)?.value;
    const receberEmail = tagPorNome("receber-email", false)?.value;
